        ...
        <div className="projects-top">
          ...
          <a href="https://www.canva.com/design/DAG2oe_1Los/QY5HZnstNK0z1RRmhEjVpQ/edit"
            ...
            <div className="project-info">
              ...
              <div className="project-title">Kilowhatt</div>
              ...
              <div className="project-link">
                <span><a href="#kilowhatt" target="_blank">Case Study<FaChevronRight /></a></span> 
                </div>
            </div>
          </div>
          ...
          <div className="project-card">
             ...
             <a href="https://www.figma.com/design/6LrCjA3aBRdR1nSk6yE1gq/Techlympic-Contest"
               target="_blank" rel="noreferrer">
            ...
            <div className="project-info">
              ...
              <div className="project-title">Techlympics Website</div>
